...
const trailers = [
  {
    ...
    videoId: "qqrpMRDuPfc", // main YouTube id (works with embed)
    thumbnail:
      "https://img.youtube.com/vi/qqrpMRDuPfc/hqdefault.jpg",
  },
  {
    id: 2,
    ...
    videoId: "8ugaeA-nMTc",
    thumbnail:
      "https://img.youtube.com/vi/8ugaeA-nMTc/hqdefault.jpg",
  },
  {
    id: 3,
    ...
    videoId: "eOrNdBpGMv8",
    thumbnail:
      "https://img.youtube.com/vi/eOrNdBpGMv8/hqdefault.jpg",
  },
  {
    id: 4,
    ...
    videoId: "itnqEauWQZM",
    thumbnail:
      "https://img.youtube.com/vi/itnqEauWQZM/hqdefault.jpg",
  },
];
...
const TrailerSection = () => {
  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-44 text-white mt-16 mb-24">
      {/* Title */}
